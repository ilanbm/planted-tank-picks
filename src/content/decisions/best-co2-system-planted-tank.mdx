...
**Drop checker.** A small glass device that holds a 4-dKH reference solution and a pH indicator. It changes color (blue → green → yellow) to tell you dissolved CO₂ concentration at the tank over 1–2 hours. Green = ~30 ppm, which is the target. Yellow means you're overdosing.
...
- **Buying a single-stage "starter kit" on Amazon to save $80.** It'll work for a month, then kill your fish.

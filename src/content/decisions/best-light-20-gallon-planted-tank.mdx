...
## Why the Chihiros WRGB II is the high-tech upgrade

For a CO₂-injected 20-gallon with demanding plants, the Chihiros WRGB II is the spectrum standard. Discrete red, green, blue, and white LEDs deliver the most accurate color rendering in the consumer space — reds pop, greens stay vibrant, and the overall tank looks like a magazine photo rather than a blue-tinted science project.

PAR output is high (70–100 at substrate on a 20). Programmability via Chihiros Commander app is more polished than Fluval's. The downsides are price (2–3× the Plant 3.0) and heat — the aluminum body gets warm enough that it warrants placement at least 2 inches above the waterline.
